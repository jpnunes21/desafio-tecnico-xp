...
describe("01 - Crie um endpoint para a listagem de ativos", () => {
    ...
    it('Será validado que é possível listar todos os ativos com sucesso', () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield (0, supertest_1.default)(app_1.default).get("/ativos");
